...
export default function Home() {
  ...
  return (
    <main className="bg-neutral-950"> {/* Fundo Geral Preto */}
      
      {/* 1. HERO SECTION */}
     <section ref={container} className="h-screen w-full relative flex items-center justify-center overflow-hidden bg-black">
...
<motion.div style={{ opacity }} className="z-10 relative text-center px-4 w-full">
